...
Imports System.IO
Public Class Customer___Brake_Drum__Categ__v3
    ...
    Private Sub Customer___Brake_Drum__Categ__v3_Load(sender As Object, e As EventArgs) Handles MyBase.Load
