...
Imports System.IO
Public Class Customer___Brake_Fluid__Categ__v3
    ...
    Private Sub Customer__Brake_Fluid__Categ__v3_Load(sender As Object, e As EventArgs) Handles MyBase.Load
